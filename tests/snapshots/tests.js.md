...
> Snapshot 1
    ...
    `:root {␊
      ...
      --font-feature-settings-sans: "kern" 1;␊
      --line-height-sans: 1.4em;␊
      --letter-spacing-sans: calc(1px - 0.025em);␊
      --font-family-serif: MessinaSerif;␊
      --font-feature-settings-serif: "kern" 1;␊
      --line-height-serif: 1.4em;␊
      --letter-spacing-serif: calc(1px - 0.025em);␊
      --font-family-modern: MessinaModern;␊
      --font-feature-settings-modern: "kern" 1;␊
      --line-height-modern: 1.4em;␊
      --letter-spacing-modern: calc(1px - 0.025em);␊
    }␊
...
> Snapshot 1
    ...
    `/* ( a: ( breakpoint: 30em, outer-right: calc(31.25vw + -6.25rem), outer-left: calc(31.25vw + -6.25rem) ), b: ( breakpoint: 40em, font-mods: ( serif: ( l: 30px 1.1 ) ) ), c: ( font-size: 18px, breakpoint: 60em, outer-right: 200px, outer-left: 200px ) ) */␊
    :root {␊
      --breakpoint-a: 30em;␊
      --outer-width-a: 30rem;␊
      --breakpoint-b: 40em;␊
    ...
    ␊
    /* ( a: ( inner-x: 1rem, inner-y: 1.5rem, outer-top: 2rem, outer-right: calc(31.25vw + -6.25rem), outer-bottom: 2rem, outer-left: calc(31.25vw + -6.25rem), grid-cols: 12, inner-mods: ( s: 0.5, m: 1, l: 2 ), font-mods: ( sans: ( m: 18px 1.3, l: 24px 1.2 ), serif: ( m: 18px 1.3, l: 24px 1.2 ) ), inner-y-mods: ( s: 0.5, m: 3.5rem, l: 2 ), font-size: 16px, outer-width: 30rem, breakpoint: 30em ), b: ( inner-x: 1rem, inner-y: 1.5rem, outer-top: 2rem, outer-right: calc(31.25vw + -6.25rem), outer-bottom: 2rem, outer-left: calc(31.25vw + -6.25rem), grid-cols: 12, inner-mods: ( s: 0.5, m: 1, l: 2 ), font-mods: ( sans: ( m: 18px 1.3, l: 24px 1.2 ), serif: ( m: 18px 1.3, l: 30px 1.1 ) ), inner-y-mods: ( s: 0.5, m: 3.5rem, l: 2 ), font-size: 16px, outer-width: 40rem, breakpoint: 40em ), c: ( inner-x: 1rem, inner-y: 1.5rem, outer-top: 2rem, outer-right: 200px, outer-bottom: 2rem, outer-left: 200px, grid-cols: 12, inner-mods: ( s: 0.5, m: 1, l: 2 ), font-mods: ( sans: ( m: 18px 1.3, l: 24px 1.2 ), serif: ( m: 18px 1.3, l: 30px 1.1 ) ), inner-y-mods: ( s: 0.5, m: 3.5rem, l: 2 ), font-size: 18px, outer-width: 53.3333333333rem, breakpoint: 60em ) ) */`
