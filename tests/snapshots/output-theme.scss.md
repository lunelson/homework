...
> Snapshot 1
    ...
    ␊
    a:link {␊
      color: rgba(var(--link-color), var(--fg-opacity, 1));␊
    }␊
    ␊
    a:visited {␊
      color: rgba(var(--visited-color), var(--fg-opacity, 1));␊
    }␊
    ␊
    a:hover {␊
      color: rgba(var(--hover-color), var(--fg-opacity, 1));␊
    }␊
    ␊
    a:focus {␊
      color: rgba(var(--focus-color), var(--fg-opacity, 1));␊
    }␊
    ␊
    a:active {␊
      color: rgba(var(--active-color), var(--fg-opacity, 1));␊
    }␊
    ␊
    [class^=fg-], [class*=" fg-"] {␊
      color: rgba(var(--fg-color), var(--fg-opacity, 1));␊
