...
> Snapshot 1
    ...
    ␊
    .mcol-flow, [class^=mcol-flow-], [class*=" mcol-flow-"] {␊
    ...
    ␊
    .mcol-flow-s, .flow-s, .grid-s {␊
      --row-gap: var(--inner-y-s);␊
    }␊
    ␊
    .mcol-flow-m, .flow-m, .grid-m {␊
      --row-gap: var(--inner-y-m);␊
    }␊
    ␊
    .mcol-flow-l, .flow-l, .grid-l {␊
    ...
    * {␊
    ...
    ␊
      .flow > .a__span-auto, [class^=flow-] > .a__span-auto, [class*=" flow-"] > .a__span-auto {␊
        flex: 1 1 auto;␊
        --column-span: 0;␊
      }␊
    ␊
    ...
    ␊
      .flow > .b__span-auto, [class^=flow-] > .b__span-auto, [class*=" flow-"] > .b__span-auto {␊
        flex: 1 1 auto;␊
        --column-span: 0;␊
      }␊
    ␊
    ...
    ␊
      .flow > .c__span-auto, [class^=flow-] > .c__span-auto, [class*=" flow-"] > .c__span-auto {␊
        flex: 1 1 auto;␊
        --column-span: 0;␊
      }␊
    ␊
